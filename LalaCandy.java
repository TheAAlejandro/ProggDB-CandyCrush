...
public class LalaCandy{
    ...
    public void drawLala(Graphics2D g2d){
        ...
        Rectangle2D.Double shadow = new Rectangle2D.Double(x - size + size/4 - 2, y - size + size/2 + 1, 1 * size + 2, 0.5 * size + 2);
        ...
        for (int i = startX; i < endX; i += lineSpacing) {
            ...
            g2d.drawLine(i, rectY, i - rectY + rectHeight, rectY + rectHeight);
        ...
        for (int i = startX; i < endX; i += lineSpacing) {
            ...
            g2d.drawLine(i, rectY - 1, i - rectY + rectHeight, rectY + rectHeight - 1);
